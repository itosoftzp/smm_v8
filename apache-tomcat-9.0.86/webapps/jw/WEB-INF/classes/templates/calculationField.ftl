<div class="form-cell" ${elementMetaData!}>
    ...
    <#else>
        ...
        <script type="text/javascript">
            ...
            options_calField_${element.properties.elementUniqueKey}['id'] = '${element.properties.id!}';
    ...
    <#if element.properties.hidden! == 'true'>
        <#if includeMetaData!>
            ...
            <input id="${elementParamName!}" name="${elementParamName!}" type="text" value="${value!?html}" class="calFiel_${element.properties.elementUniqueKey!}" readonly/>
        <#else>
    ...
    <#else>
        ...
        <#if element.properties.readonlyLabel! == 'true' >
            <span class="calculationField_value">${valueLabel!?html}</span>
            <input id="${elementParamName!}" name="${elementParamName!}" type="hidden" value="${value!?html}" class="calFiel_${element.properties.elementUniqueKey!}"/>
        <#else>
