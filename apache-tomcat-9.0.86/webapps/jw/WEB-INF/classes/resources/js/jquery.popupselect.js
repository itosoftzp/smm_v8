    ...
    var methods = {
        ...
        init: function(options) {
            return this.each(function() {
                ...
                // append item
                element.closest(".ui-screen-hidden").after(span);

                if (!readOnly) {
                    var button = element.closest(".ui-screen-hidden").next(".selector_element").children(".selector_button");
        ...
        refresh: function() {
            return this.each(function() {
                ...
                // clear items
                var selectorItems = element.closest(".ui-screen-hidden").next(".selector_element").find(".selector_items");
                selectorItems.empty();
                ...
                if (!readOnly) {
                    ...
                    element.closest(".ui-screen-hidden").next(".selector_element").find(".selector_remove").click(function(event, ui) {
                        event.preventDefault();
                        var item = $(this).siblings(".selector_label").attr("option-value");
