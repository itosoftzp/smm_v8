...
/***/ function(module, exports, __webpack_require__) {
	...
	registerOperation(_minus2.default.SYMBOL, _minus2.default);
        ...
        /**
         * Return the javascript function by name. Added by joget
         * @param {String} name
         * @returns function
         */
        function getJsFunction(name) {
            try {
                if ($.isFunction(name)) {
                    return name;
                }
	...
	function evaluateByOperator(operator) {
	  var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
          /* Joget Custom  Start : to support custom js function*/
          var tempoperator = operator.toUpperCase();
          if (!availableOperators[tempoperator]) {
            try {
                var jsFunc = getJsFunction(operator);
                return jsFunc.apply(null, _toConsumableArray(params));
            } catch (err) {
                throw Error(_error.ERROR_NAME);
            }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.YIELDMAT = function() {
	  throw new Error('YIELDMAT is not implemented');
        ...
        exports.FORMDATA = function(formDefId, primaryKey, fieldName) {
            return JSpreadShetFormDataLoader.load(formDefId, primaryKey, fieldName);
        };
/***/ },
/* 31 */
/***/ function(module, exports, __webpack_require__) {
