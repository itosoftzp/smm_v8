...
$(document).ready(function(){checkCookie();$('#smallFont').click(function(){setFontSize("13");setCookie("13");});$('#mediumFont').click(function(){setFontSize("17");setCookie("17");});$('#bigFont').click(function(){setFontSize("20");setCookie("20");});try{$('#sidebar').perfectScrollbar();}catch(e){}
$("#mobile_menu.btn.btn-navbar").click(function(){$(".nav-collapse.sidebar-nav").addClass("collapse");$(".nav-collapse.sidebar-nav").toggleClass("in");});$("input[type=submit], button").addClass("btn");$(".category.active > ul").show();$(".rowCount").each(function(){var count=$(this).text().replace("(","").replace(")","");$(this).text(count);$(this).addClass("pull-right badge");});$('.category .dropdown').append("<span class=\"pull-right\"><i class=\"fa fa-angle-down\"></i></span>");$('.category.active .dropdown .fa-angle-down').addClass("fa-angle-up").removeClass("fa-angle-down");$('.category .dropdown').click(function(e){e.preventDefault();$(this).parent().find('ul').slideToggle();if($(this).find(".fa-angle-down").length>0){$(this).find(".fa-angle-down").addClass("fa-angle-up").removeClass("fa-angle-down");}else{$(this).find(".fa-angle-up").addClass("fa-angle-down").removeClass("fa-angle-up");}});$(".category.active > ul").parent().removeClass("active");loadInbox();widthFunctions();$(".page_loading").remove();});function loadInbox(){if($(".inbox-notification").length===1){loadInboxData();$(".inbox-notification .refresh").on("click",function(e){e.preventDefault();loadInboxData();});}}
...
$(window).on("resize",widthFunctions);function widthFunctions(e){var winHeight=$(window).height();var winWidth=$(window).width();if(screen.width<winWidth){winWidth=screen.width;}
var contentHeight=$("#content.page_content").height();if(winHeight){$("#content.page_content").css("min-height",winHeight);}
if(winWidth<980&&winWidth>750){if($("#sidebar-left").hasClass("span2")){$("#sidebar-left").removeClass("span2");$("#sidebar-left").addClass("span1");}
if($("#content.page_content").hasClass("span10")){$("#content.page_content").removeClass("span10");$("#content.page_content").addClass("span11");}
$("#sidebar a").css("white-space","nowrap");}else{if($("#sidebar-left").hasClass("span1")){$("#sidebar-left").removeClass("span1");$("#sidebar-left").addClass("span2");}
if($("#content.page_content").hasClass("span11")){$("#content.page_content").removeClass("span11");$("#content.page_content").addClass("span10");}
$("#sidebar a").css("white-space","normal");}}}(window.jQuery);
